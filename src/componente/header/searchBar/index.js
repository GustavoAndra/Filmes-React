...
const Favorites = () => {
  ...
  useEffect(() => {
    fetchMovieDetails(favoriteMovies);
  }, [favoriteMovies]);
  ...
  const carouselSettings = {
    ...
    infinite: true,
    speed: 500,
    slidesToShow: 2, // Quantidade de slides visíveis ao mesmo tempo
    slidesToScroll: 1, // Quantidade de slides a serem rolados de uma vez
  };
